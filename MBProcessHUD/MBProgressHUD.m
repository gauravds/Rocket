...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
    [CommonFunctions setNetworkActivityIndicatorVisible:YES];
...
//        [targetForExecution performSelector:methodForExecution withObject:objectForExecution  afterDelay:0];
        
#pragma clang diagnostic pop       
        
        
        
//        IMP imp = [targetForExecution performSelector:methodForExecution withObject:objectForExecution];
//        void (*func)(id, SEL) = (void *)imp;
//        func(targetForExecution, methodForExecution);
...
- (void)done {
    [CommonFunctions setNetworkActivityIndicatorVisible:NO];
    isFinished = YES;
