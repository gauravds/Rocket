...
//        pr(@"It is%@ main thread",[NSThread isMainThread]?@"":@" not");
...
//            pr(@"image to download URL %@",imageURL);
            ...
            if (con) {
                ...
                pro(@"GPImageView Image Connection is NULL");
            }
        });
